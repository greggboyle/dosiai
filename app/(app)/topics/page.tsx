...
// Realistic seed data (E6: activitySparkline removed, computed on demand; C5: seeds→searchSeeds, isArchived→status)
const mockTopics: Topic[] = [
  {
    id: '1',
    name: 'FMCSA compliance',
    description: 'Federal Motor Carrier Safety Administration rules, ELD mandates, and HOS compliance signals affecting carrier customers',
    importance: 'critical',
    searchSeeds: ['FMCSA', 'ELD mandate', 'Hours of Service', 'carrier compliance', 'DOT enforcement'],
    itemCountLast7Days: 5,
    itemCountLast7DaysChange: 2,
    itemCountLast30Days: 18,
    itemCountLast30DaysChange: 3,
    linkedCompetitorIds: ['1', '4'],
    linkedCompetitorNames: ['Acme Logistics', 'ChainShield'],
  ...
  },
  {
    ...
    description: 'Robotics, autonomous delivery, and drone-based last-mile fulfillment innovations',
    importance: 'high',
    searchSeeds: ['last-mile robot', 'autonomous delivery', 'delivery drone', 'sidewalk robot'],
    itemCountLast7Days: 2,
    itemCountLast7DaysChange: -1,
    itemCountLast30Days: 9,
    itemCountLast30DaysChange: -2,
    linkedCompetitorIds: ['2', '3'],
    linkedCompetitorNames: ['FreightHero', 'RouteIQ'],
  ...
  },
  {
    ...
    description: 'Executive moves, departures, and key hires across the competitive landscape',
    importance: 'medium',
    searchSeeds: ['VP hire', 'CEO change', 'executive departure', 'leadership announcement'],
    itemCountLast7Days: 3,
    itemCountLast7DaysChange: 0,
    itemCountLast30Days: 14,
    itemCountLast30DaysChange: 0,
    linkedCompetitorIds: ['1', '2', '3', '4'],
    linkedCompetitorNames: ['Acme Logistics', 'FreightHero', 'RouteIQ', 'ChainShield'],
